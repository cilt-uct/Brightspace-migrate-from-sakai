...
from work.lessonbuilder_add_resources_html import main
...
class AddResourcesHtmlTestCase(unittest.TestCase):
    ...
    def test_add_resource_html(self, _):
        ...
        xml_old = self.ROOT_DIR + '/test_files/site_resource_html-archive/lessonbuilder.old'
        ...
        with open(file_path, "r", encoding="utf8") as fp:
            ...
            self.assertEqual(10, len(paragraphs))
